This project is no longer officially maintained. This is forked from the `AsteriskLabs` repository to enable us to use this with Rails 5+ and Devise 4+.

The actual version of this that runs for the Red Canary Portal is located in the Portal repository as `vendor/gems/devise_google_authenticator`.
...
* gem 'devise'
* gem 'devise_google_authenticator', '0.4.0'
...
== Changes
* Version 0.4.0 - Devise 4 and Rails 5.0 support
