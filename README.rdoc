...
If you have a more recent fork and you'd like us to link to it from here, please get in touch.
...
== Changes
* Version 0.3.17 - A new secret code (assign_auth_secret) for the google authenticator is created, if a user visits the settings page as long as the google authenticator is not active.
